...
function Header() {
    ...
    return (
        <div onClick={() => router.push('/')} className="shadow-sm border-b bg-white sticky top-0 z-50">
            <div className="flex justify-between max-w-6xl mx-5 lg:mx-auto">
                ...
                <div onClick={() => router.push('/')} className="relative w-10 h-10 lg:hidden flex-shrink-0  mt-4 cursor-pointer">
                    <Image 
