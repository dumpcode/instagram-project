...
function Post({ id, username, userImg, img, caption }) {
    ...
    const [userNameLiked, setUsernameLike] = useState([]);
    ...
    return(
        <div className="bg-white my-7 border rounded-sm mx-2.5">
        ...
        <div className="flex items-center p-2">
            ...
            <EmojiHappyIcon className="h-7 f"/>
            <input 
            type="text"
            value={comment}
            onChange={e => setComment(e.target.value)} 
            placeholder="Add a comnment..."
